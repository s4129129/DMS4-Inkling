...
const EXACT_TRANSLATIONS = new Map(
  Object.entries({
    ...
    "Configure in Settings": "Thay \u0111\u1ed5i trong c\u00e0i \u0111\u1eb7t",
    Buy: "Mua",
    Need: "Cần",
    Free: "Miễn phí",
    Search: "Tìm kiếm",
    ...
    "Sleek tech interface": "Giao diện công nghệ tinh tế",
    "Main1": "Nền chính 1",
    "Main2": "Nền chính 2",
    ...
    "Total pages gained": "Tổng trang đã nhận",
    "Claimed today": "Đã nhận hôm nay",
